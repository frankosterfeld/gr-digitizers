...
#include <gnuradio/picoscope5000/picoscope5000.h>
...
class picoscope_5000_impl : public digitizers::picoscope_impl
{
private:
...
public:
    picoscope_5000_impl(const digitizers::digitizer_args& args,
...
private:
    ...
    uint32_t convert_frequency_to_ps5000_timebase(double desired_freq,
                                                   double& actual_freq);
};

class picoscope5000_cpu : public virtual picoscope5000
{
public:
    explicit picoscope5000_cpu(block_args args);
