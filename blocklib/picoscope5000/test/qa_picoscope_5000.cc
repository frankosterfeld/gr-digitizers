#include "qa_picoscope_5000.h"

#include "utils.h"
#include <digitizers/tags.h>
#include <picoscope5000/picoscope5000.h>
...
void qa_picoscope_5000::open_close()
{
    auto ps = picoscope5000::make({});
...
void qa_picoscope_5000::rapid_block_basics()
{
...
void qa_picoscope_5000::rapid_block_channels()
{
...
void qa_picoscope_5000::rapid_block_continuous()
{
...
void qa_picoscope_5000::rapid_block_downsampling_basics()
{
...
void qa_picoscope_5000::run_rapid_block_downsampling(digitizer_downsampling_mode_t mode)
{
    auto top = gr::flowgraph::make("channels");
...
void qa_picoscope_5000::rapid_block_downsampling()
{
...
void qa_picoscope_5000::rapid_block_tags()
{
...
void qa_picoscope_5000::rapid_block_trigger()
{
    auto top = gr::flowgraph::make("tags");
...
void qa_picoscope_5000::streaming_basics()
{
...
int main(int, char**)
{
    ...
    if (!var || std::string_view(var).find("5000") == std::string_view::npos) {
        std::cout
            << "'5000' not in PICOSCOPE_RUN_TESTS environment variable, do not run test"
            << std::endl;
        return 0;
    }
    ...
    runner.addTest(gr::picoscope5000::qa_picoscope_5000::suite());
